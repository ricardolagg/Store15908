...
function ExibeBotoesCesta(){
  try{
    ...
    if(sBrowser!='IE'){
      ...
      cell.colSpan=4;
      cell.innerHTML="<table cellspacing='0' cellpadding='0' width='100%'><tr><td align='right'><input name='btComprar1' value='Comprar' type='image' title='Comprar' border=0 src='"+ sCaminhoImages +"fbbbotcomprar.png' onclick='ComprarImg()'></td></tr></table>";
    }
    var row=table.insertRow(-1);
    var cell=row.insertCell(-1);
    cell.colSpan=4;
    cell.innerHTML="<table cellspacing='0' cellpadding='0' width='100%'><tr><td width='33%'><a href='home.asp?IDLoja="+ IDLoja +"'><img src='"+ sCaminhoImages +"fbbbotcontcomprando.png' border='0'></a></td><td width='33%' align='center'><input name='Recalcular' value='Recalcular' type='image' title='Recalcular' border='0' onclick='document.Lista.submit()' src='"+ sCaminhoImages +"fbbbotrecalcular.png'></td><td width='33%' align='right'><input name='btComprar2' value='Comprar' type='image' title='Comprar' border=0 src='"+ sCaminhoImages +"fbbbotcomprar.png' onclick='ComprarImg()'></td></tr></table>";
...
function ComprarImg(){document.getElementsByName("Comprar")[0].click()}
